...
public class Sto5_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto5));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto5_t1));
