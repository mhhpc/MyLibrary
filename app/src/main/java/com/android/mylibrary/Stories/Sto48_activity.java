...
public class Sto48_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto48));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto48_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/table-with-phone_pp14.jpg").error(R.drawable.error).into(imageView1);
