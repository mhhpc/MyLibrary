...
public class Sto28_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto28));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto28_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/butterflies_mzdr.jpg").error(R.drawable.error).into(imageView1);
