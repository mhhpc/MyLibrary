...
public class Sto19_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto19));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto19_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/502018121_univ_lsr_lg_21l.jpg").noFade().error(R.drawable.error).into(imageView1);
