...
public class Sto35_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto35));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto35_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/coffee-menu4_tkm2.jpg").error(R.drawable.error).into(imageView1);
