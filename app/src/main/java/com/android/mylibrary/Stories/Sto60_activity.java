...
public class Sto60_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto60));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto60_t1));
