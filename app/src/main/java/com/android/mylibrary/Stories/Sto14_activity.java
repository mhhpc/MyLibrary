...
public class Sto14_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto14, R.string.sto14_t1, R.string.sto14_t2);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/roya_in9.jpg",
                "https://s8.uupload.ir/files/ajaj(1)_qg88.jpg");
    }
}