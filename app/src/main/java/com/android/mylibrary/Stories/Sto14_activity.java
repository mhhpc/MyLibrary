...
public class Sto14_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto14));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto14_t1));
        ((TextView) findViewById(R.id.t2)).setText(getString(R.string.sto14_t2));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/roya_in9.jpg").noFade().error(R.drawable.error).into(imageView1);

        ImageView imageView2 = (ImageView) findViewById(R.id.im1);
        Picasso.get().load("https://s8.uupload.ir/files/ajaj(1)_qg88.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView2);
