...
public class Sto44_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto44));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto44_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/water-well_lfl.jpg").error(R.drawable.error).into(imageView1);
