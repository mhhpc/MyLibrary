...
public class Sto41_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto41));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto41_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/rhrh_h52y.jpg").error(R.drawable.error).into(imageView1);
