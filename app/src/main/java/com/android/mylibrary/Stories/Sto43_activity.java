...
public class Sto43_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto43));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto43_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/077206e2-2a2a-4a21-88f1-079c9135fc6e-1200x900_2dpo.jpg").error(R.drawable.error).into(imageView1);
