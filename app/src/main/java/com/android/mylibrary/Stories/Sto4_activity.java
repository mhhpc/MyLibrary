...
public class Sto4_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto4, R.string.sto4_t1, R.string.sto4_t2);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/most-expensive-homes-042616-hero1_v0hj.jpg",
                "https://s8.uupload.ir/files/funeral001-56a2755f5f9b58b7d0cac54a_ldfn.jpg");
    }
}