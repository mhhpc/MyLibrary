...
public class Sto37_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto37));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto37_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/3595221_rqaq.jpg").error(R.drawable.error).into(imageView1);
