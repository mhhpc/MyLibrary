...
public class Sto9_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto9));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto9_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/3002466_brs6.jpg").error(R.drawable.error).into(imageView1);
