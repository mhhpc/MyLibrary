...
public class Sto2_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto2, R.string.sto2_t1, R.string.sto2_t2);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/ed2b1b0ad5e44bd58d05de6a8558b19e_djlo.jpg",
                "https://s8.uupload.ir/files/apartments-on-fire-migrated_nhrm.jpg");
    }
}