...
public class Sto39_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto39));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto39_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/8994d7607baec2d7d96239d0cb82f74f_on7j.jpg").error(R.drawable.error).into(imageView1);
