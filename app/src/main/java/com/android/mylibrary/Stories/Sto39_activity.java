...
public class Sto39_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto39, R.string.sto39_t1);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/8994d7607baec2d7d96239d0cb82f74f_on7j.jpg");
    }
}