...
public class Sto54_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto54));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto54_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/campfire_soa7.jpg").error(R.drawable.error).into(imageView1);
