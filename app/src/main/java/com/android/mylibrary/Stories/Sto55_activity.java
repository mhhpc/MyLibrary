...
public class Sto55_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto55));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto55_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/1-1_vjl3.jpg").error(R.drawable.error).into(imageView1);
