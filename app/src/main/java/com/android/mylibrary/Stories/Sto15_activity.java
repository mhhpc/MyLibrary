...
public class Sto15_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto15));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto15_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/169770965_5q6n.jpg").noFade().error(R.drawable.error).into(imageView1);
