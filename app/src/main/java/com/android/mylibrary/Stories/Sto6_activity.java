...
public class Sto6_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto6, R.string.sto6_t1);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/jackal-symbolism-and-meaning-04a4efbd_3df4.jpg");
    }
}
