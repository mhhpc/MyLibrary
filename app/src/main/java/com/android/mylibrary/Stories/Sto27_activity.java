...
public class Sto27_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto27));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto27_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/3037_8ke.jpg").noFade().error(R.drawable.error).into(imageView1);
