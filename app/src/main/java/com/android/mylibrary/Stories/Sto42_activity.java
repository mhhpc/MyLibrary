...
public class Sto42_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto42));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto42_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/08-01_g6y7.jpg").error(R.drawable.error).into(imageView1);
