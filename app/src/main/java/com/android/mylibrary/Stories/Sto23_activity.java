...
public class Sto23_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto23));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto23_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/shtrvl1000219www.tiktarh.com__sani.jpg").noFade().error(R.drawable.error).into(imageView1);
