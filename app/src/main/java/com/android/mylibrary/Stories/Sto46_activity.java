...
public class Sto46_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto46));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto46_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/8d3452e5e0956f2a97768276a3f09a4e-e1705487782263_wdy6.jpg").error(R.drawable.error).into(imageView1);
