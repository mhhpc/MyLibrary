...
public class Sto46_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto46, R.string.sto46_t1);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/8d3452e5e0956f2a97768276a3f09a4e-e1705487782263_wdy6.jpg");
    }
}