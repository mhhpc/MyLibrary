...
public class Sto53_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto53));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto53_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/0_h7y9.jpg").error(R.drawable.error).into(imageView1);
