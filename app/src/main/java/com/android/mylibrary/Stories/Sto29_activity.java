...
public class Sto29_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto29, R.string.sto29_t1, R.string.sto29_t2);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/5f0d7f5a19134_merh.jpg",
                "https://s8.uupload.ir/files/1-21-os2xwu6nvzf7io4zvow2y7roa056hyh674olhcslfs_fkt9.jpg");
    }
}