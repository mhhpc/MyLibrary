...
public class Sto29_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto29));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto29_t1));
        ((TextView) findViewById(R.id.t2)).setText(getString(R.string.sto29_t2));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/5f0d7f5a19134_merh.jpg").error(R.drawable.error).into(imageView1);

        ImageView imageView2 = (ImageView) findViewById(R.id.im1);
        Picasso.get().load("https://s8.uupload.ir/files/1-21-os2xwu6nvzf7io4zvow2y7roa056hyh674olhcslfs_fkt9.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView2);
