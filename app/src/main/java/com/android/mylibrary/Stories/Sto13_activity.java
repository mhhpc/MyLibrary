...
public class Sto13_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto13));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto13_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/cart1020560www.tiktarh.com__vrx9.jpg").noFade().error(R.drawable.error).into(imageView1);
