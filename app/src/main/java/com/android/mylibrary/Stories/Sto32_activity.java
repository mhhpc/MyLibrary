...
public class Sto32_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto32, R.string.sto32_t1);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/whitepelican_edit_shadowlift_muhg.jpg");
    }
}