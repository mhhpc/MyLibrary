...
public class Sto32_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto32));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto32_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/whitepelican_edit_shadowlift_muhg.jpg").error(R.drawable.error).into(imageView1);
