...
public class Sto20_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto20));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto20_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/hioggoug_chf5.jpg").noFade().error(R.drawable.error).into(imageView1);
