...
public class Sto38_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto38));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto38_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/70986950980_f2hw.jpg").error(R.drawable.error).into(imageView1);
