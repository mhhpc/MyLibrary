...
public class Sto38_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto38, R.string.sto38_t1);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/70986950980_f2hw.jpg");
    }
}