...
public class Sto52_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto52));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto52_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/2-lane-arch-bridge-with-pedestrian-walkway-1000_xfia.jpg").error(R.drawable.error).into(imageView1);
