...
public class Sto51_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto51));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto51_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/51951042270_78ea1e8590_h.7_egok.jpg").error(R.drawable.error).into(imageView1);
