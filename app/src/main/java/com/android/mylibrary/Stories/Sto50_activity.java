...
public class Sto50_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto50));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto50_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/marry-a-poor-man_g605.jpg").error(R.drawable.error).into(imageView1);
