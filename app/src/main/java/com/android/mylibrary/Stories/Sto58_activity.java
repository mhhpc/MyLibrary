...
public class Sto58_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto58));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto58_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/61654b3b-99a_dc3.jpg").error(R.drawable.error).into(imageView1);
