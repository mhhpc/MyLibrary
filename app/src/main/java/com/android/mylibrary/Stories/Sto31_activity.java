...
public class Sto31_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto31));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto31_t1));
        ((TextView) findViewById(R.id.t2)).setText(getString(R.string.sto31_t2));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/animals-634-infinitychap.com-0700696742_pthl.jpg").error(R.drawable.error).into(imageView1);

        ImageView imageView2 = (ImageView) findViewById(R.id.im1);
        Picasso.get().load("https://s8.uupload.ir/files/ss-animals_mix-082_q5dg.jpg").placeholder(R.drawable.progress_animation).error(R.drawable.error).into(imageView2);
