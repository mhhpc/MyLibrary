...
public class Sto31_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto31, R.string.sto31_t1, R.string.sto31_t2);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/animals-634-infinitychap.com-0700696742_pthl.jpg",
                "https://s8.uupload.ir/files/ss-animals_mix-082_q5dg.jpg");
    }
}