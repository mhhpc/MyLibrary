...
public class Sto45_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto45));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto45_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/d557ec67f01a4fe49dd9f84fadbe9d72_dlcc.jpg").error(R.drawable.error).into(imageView1);
