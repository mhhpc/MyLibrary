...
public class Sto45_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto45, R.string.sto45_t1);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/d557ec67f01a4fe49dd9f84fadbe9d72_dlcc.jpg");
    }
}