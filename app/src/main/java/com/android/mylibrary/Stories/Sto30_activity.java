...
public class Sto30_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto30));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto30_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/demonios_s1000rr-group-riding_4eq4.jpg").error(R.drawable.error).into(imageView1);
