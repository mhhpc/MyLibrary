...
public class Sto59_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto59));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto59_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/4707376_1uba.jpg").error(R.drawable.error).into(imageView1);
