...
public class Sto22_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto22));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto22_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/shoe-tools9_4nr7.jpg").noFade().error(R.drawable.error).into(imageView1);
