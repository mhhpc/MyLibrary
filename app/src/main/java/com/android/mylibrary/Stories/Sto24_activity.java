...
public class Sto24_activity extends BaseStoryActivity {

    @Override
    protected List<Integer> getTextIds() {
        return Arrays.asList(R.string.stories_tsto24, R.string.sto24_t1);
    }
    ...
    protected List<String> getImageUrls() {
        return Arrays.asList("https://s8.uupload.ir/files/large_400ad4e1-d127-4b35-9304-5901b5a4a2de_amg1.jpg");
    }
}