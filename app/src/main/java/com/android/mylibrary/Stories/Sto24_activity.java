...
public class Sto24_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto24));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto24_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/large_400ad4e1-d127-4b35-9304-5901b5a4a2de_amg1.jpg").noFade().error(R.drawable.error).into(imageView1);
