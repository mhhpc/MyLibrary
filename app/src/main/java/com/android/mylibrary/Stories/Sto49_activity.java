...
public class Sto49_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto49));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto49_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/jasper-boer-1fuu0dratom-unsplash-scaled-1_eh5d.jpg").error(R.drawable.error).into(imageView1);
