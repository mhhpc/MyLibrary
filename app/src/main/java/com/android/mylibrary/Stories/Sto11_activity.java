...
public class Sto11_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto11));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto11_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/15637826_4phi.jpg").noFade().error(R.drawable.error).into(imageView1);
