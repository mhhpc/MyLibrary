...
public class Sto36_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto36));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto36_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/sbberbhr_a90.jpg").error(R.drawable.error).into(imageView1);
