...
public class Sto40_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto40));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto40_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/15550031_t28x.jpg").error(R.drawable.error).into(imageView1);
