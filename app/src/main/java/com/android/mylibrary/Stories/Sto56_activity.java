...
public class Sto56_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto56));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto56_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/jdjfhfge_7acd.jpg").error(R.drawable.error).into(imageView1);
