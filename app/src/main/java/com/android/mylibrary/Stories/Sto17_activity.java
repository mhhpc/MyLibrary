...
public class Sto17_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto17));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto17_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/ydz8pjeigxim_z5bx.jpg").noFade().error(R.drawable.error).into(imageView1);
