...
public class Sto33_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto33));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto33_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/nwjkowi43bke_2e6u.jpg").error(R.drawable.error).into(imageView1);
