...
public class Sto12_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto12));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto12_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/jakav.com-ax-photo-tabiat-nature-tasavir-iran-ranginkaman_o1u6.jpg").noFade().error(R.drawable.error).into(imageView1);
