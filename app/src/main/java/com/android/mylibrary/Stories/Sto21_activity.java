...
public class Sto21_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto21));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto21_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/master_groph_14-4_14_oe8k.jpg").noFade().error(R.drawable.error).into(imageView1);
