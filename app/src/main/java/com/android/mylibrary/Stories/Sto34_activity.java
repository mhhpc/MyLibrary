...
public class Sto34_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto34));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto34_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/74d1e572-2120-43f1-894b-c15b2af6e64f_kemw.jpg").error(R.drawable.error).into(imageView1);
