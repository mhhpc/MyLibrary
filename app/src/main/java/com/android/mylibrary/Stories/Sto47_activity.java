...
public class Sto47_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto47));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto47_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/89405_405_vppq.jpg").error(R.drawable.error).into(imageView1);
