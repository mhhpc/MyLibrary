...
public class Sto16_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set text
        ((TextView) findViewById(R.id.tv1)).setText(getString(R.string.stories_tsto16));
        ((TextView) findViewById(R.id.t1)).setText(getString(R.string.sto16_t1));
        ...
        Picasso.get().load("https://s8.uupload.ir/files/gwl-chrg-jdw_0crf.jpg").noFade().error(R.drawable.error).into(imageView1);
